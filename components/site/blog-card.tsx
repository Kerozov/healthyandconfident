  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col p-6">
        ...
        <h3 className="mt-3 font-display text-xl font-semibold leading-snug transition-colors group-hover:text-forest-500">
          {post.title}
        </h3>
        <p className="mt-2 line-clamp-3 flex-1 text-sm text-ink-soft">{post.excerpt}</p>
        <div className="mt-5 flex items-center justify-between text-sm font-semibold text-forest-500">
