...
const COPY = {
  bg: {
    ...
    healthTitle: "С какво можем да ти помогнем?",
    healthHint: "Избери едно — ще ти пратим най-подходящото съдържание.",
    ir: "Инсулинова резистентност",
    diabetes: "Диабет тип 2",
    general: "Нямам тези проблеми — искам общо отслабване / повече енергия",
    submit: "Изпрати",
    loading: "...",
  ...
  en: {
    ...
    healthTitle: "How can we help you?",
    healthHint: "Choose one — we'll send the most relevant content.",
    ir: "Insulin resistance",
    diabetes: "Type 2 Diabetes",
    general: "None of these — general weight loss / more energy",
    submit: "Submit",
    loading: "...",
