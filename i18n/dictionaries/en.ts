...
export const en: Dictionary = {
    ...
    items: [
      {
        ...
        price: "£23",
        description:
          "A gentle reset to reduce bloating, calm cravings and feel lighter fast.",
        features: ["Done-for-you menu", "Shopping list", "Daily guidance"],
        cta: "Download now",
        href: "#contact",
      },
      {
        badge: "Most popular",
        title: "Happier & Slimmer in 5 Steps",
        duration: "1:1 program",
        price: "From £59",
        description:
          "A 21-day online program to learn balanced eating, lose 3–5 kg and break the diet cycle for good.",
        features: [
          "Tasty recipes for every meal",
          "Videos on balanced eating",
      ...
      },
      {
        ...
        price: "1:1 & group",
        description:
          "Lose 5–15 kg sustainably and tackle insulin resistance & Type 2 Diabetes with full support.",
        features: [
  ...
  leadMagnet: {
    ...
    subtitle:
      "Tasty, balanced and easy — get a taste of the method that helps hundreds get healthier and more confident.",
    placeholder: "Your best email",
    button: "Send me the menu",
    consent:
      "I agree to receive helpful emails. You can unsubscribe at any time.",
  ...
  blog: {
    ...
    subtitle:
      "Practical, science-based articles on blood sugar, weight loss, mindset and feeling your best.",
  ...
  footer: {
    ...
    columns: [
      ...
      },
      {
        title: "Programs",
        links: [
          { label: "10-Day Detox", href: "/en#programs" },
          { label: "Happier & Slimmer", href: "/en#programs" },
          { label: "Live Without Resistance", href: "/en#programs" },
        ],
      },
    ],
  },
