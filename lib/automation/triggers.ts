...
> = {
  new_subscriber: {
    label: "Нов абонат",
    hint: "Първи път в списъка — сайт, ръчно или импорт. Разделяй с тагове/групи (напр. изключи „manual“).",
  },
  purchase: {
    label: "След покупка",
    hint: "След успешно плащане в Stripe. Задай продукт и/или група в „Включване“.",
  },
  form_submit: {
    label: "След форма",
  ...
  segment_entry: {
    ...
    hint: "Когато човекът за първи път влезе в избраните групи/сегменти — от форма, покупка, запис или ръчна промяна.",
  },
};
